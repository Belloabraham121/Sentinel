 ...
 * @dev This interface contains the core functions needed for liquidations and health factor checks
 */
interface IAaveV3Pool {
    /**
     * @notice Struct to store the reserve data
     */
    struct ReserveData {
    ...
    /**
     * @notice Struct to store user account data
     */
